%Responses = [900x205xcanales] datos
%Code=[900x1] Filas y columnas intensificadas
%Type=[900x1] indica que ERP es P300 y no P300
%MUD=[407x3] con las mejores caracteristicas seleccionadas
%NumberOfSequences = 15 número de intensificaciones
%trialnr=???
%NumMatrixRows = 6
%NumMatrixColumns = 6
%charvect=[36x1] valores de la matriz de deletreo
%wind=205 valores de la curva
