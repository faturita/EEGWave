...
%flags  -(string) Flags to XCOPY command (see below). Default is: '/E /F /Y /D /H'
...
%                     do not exist in the original directory (will prompt
%                     user before deleting file)
...
%                     on the back-up directory (might be useful for multiple back-ups)
%                     
%
%
